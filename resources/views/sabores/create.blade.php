                      ...
                      <div class="card-body">
                        <form action="{{route('index.store')}}" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="nome" value= "{{ isset($produto->nome) ? $produto->nome : "Nome" }} "name="nome" aria-describedby="emailHelp"
                          ...
                          <div class="form-group">
                            <div class="custom-file">
                              <input type="file" class="custom-file-input" value= {{ isset($produto->foto) ? $produto->foto : "" }} id="foto" name="foto" style="border-radius:25px">
